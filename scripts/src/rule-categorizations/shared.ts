 ...
 *
 * Whatever stands in the way of categorizing a rule must be described in `errors` instead of being
 * ignored.
 */
...
export interface RuleCategorization<CategoryId extends string> {
  /**
   * Categories to emit, in output order.
   * A rule may belong to several of them
   */
