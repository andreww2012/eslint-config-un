...
- updated [`eslint-plugin-zod` from v4.9.0 to v4.12.1](https://github.com/marcalexiei/eslint-zod/compare/eslint-plugin-zod@4.9.0...eslint-plugin-zod@4.12.1) and enabled the following rules:
...
- updated [`eslint-plugin-zod-mini` from v1.6.0 to v1.9.1](https://github.com/marcalexiei/eslint-zod/compare/eslint-plugin-zod-mini@1.6.0...eslint-plugin-zod-mini@1.9.1) and enabled the following rules:
...
- updated [`eslint-plugin-zod-core` from v1.0.9 to v1.0.14](https://github.com/marcalexiei/eslint-zod/compare/eslint-plugin-zod-core@1.0.9...eslint-plugin-zod-core@1.0.14)