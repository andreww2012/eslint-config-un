...
noPrettierIncompatibleRules: stopped disabling the following rules when the Config is on because most of the time they don't conflict with Prettier formatting:
