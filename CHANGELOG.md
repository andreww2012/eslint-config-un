...
- `typescript-eslint`: [8.32.0 → 8.38.0](https://github.com/typescript-eslint/typescript-eslint/compare/v8.32.0...v8.38.0)
...
- `eslint-plugin-jsdoc`: [50.6.14 → 51.4.1](https://github.com/gajus/eslint-plugin-jsdoc/compare/v50.6.14...v51.4.1)
- `@stylistic/eslint-plugin`: [4.2.0 → 5.2.0](https://github.com/eslint-stylistic/eslint-stylistic/compare/v4.2.0...v5.2.0)
...
- `eslint-plugin-n`: [17.18.0 → 17.21.0](https://github.com/eslint-community/eslint-plugin-n/compare/v17.18.0...v17.21.0)
...
- `eslint-plugin-package-json`: [0.31.0 → 0.46.0](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json/compare/v0.31.0...v0.46.0)
