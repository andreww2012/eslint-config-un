...
- `angular-eslint`: [19.4.0 → 20.6.0](https://github.com/angular-eslint/angular-eslint/compare/v19.4.0...v20.6.0)
...
- `typescript-eslint`: [8.32.0 → 8.46.3](https://github.com/typescript-eslint/typescript-eslint/compare/v8.32.0...v8.46.3)
...
- `eslint-plugin-package-json`: [0.31.0 → 0.65.1](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json/compare/v0.31.0...v0.65.1)
