...
- `eslint-plugin-jsdoc`: [50.6.14 → 54.1.1](https://github.com/gajus/eslint-plugin-jsdoc/compare/v50.6.14...v54.1.1)
...
- `eslint-plugin-package-json`: [0.31.0 → 0.56.0](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json/compare/v0.31.0...v0.56.0)
