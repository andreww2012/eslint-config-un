...
- `typescript-eslint`: [8.32.0 → 8.39.1](https://github.com/typescript-eslint/typescript-eslint/compare/v8.32.0...v8.39.1)
...
- `@eslint-react/eslint-plugin`: [1.49.0 → 1.52.4](https://github.com/Rel1cx/eslint-react/compare/v1.49.0...v1.52.4)
...
- `@html-eslint/eslint-plugin`: [0.40.2 → 0.45.0](https://github.com/yeonjuan/html-eslint/compare/v0.40.2...v0.45.0)
...
- `eslint-plugin-jsdoc`: [50.6.14 → 54.0.0](https://github.com/gajus/eslint-plugin-jsdoc/compare/v50.6.14...v54.0.0)
...
- `eslint-plugin-package-json`: [0.31.0 → 0.53.0](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json/compare/v0.31.0...v0.53.0)
