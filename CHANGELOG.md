...
- `angular-eslint`: [19.4.0 → 20.2.0](https://github.com/angular-eslint/angular-eslint/compare/v19.4.0...v20.2.0)
...
- `typescript-eslint`: [8.32.0 → 8.40.0](https://github.com/typescript-eslint/typescript-eslint/compare/v8.32.0...v8.40.0)
...
- `eslint-plugin-jsdoc`: [50.6.14 → 54.1.0](https://github.com/gajus/eslint-plugin-jsdoc/compare/v50.6.14...v54.1.0)
...
- `eslint-plugin-pnpm`: [0.3.1 → 1.1.1](https://github.com/antfu/pnpm-workspace-utils/compare/v0.3.1...v1.1.1)
