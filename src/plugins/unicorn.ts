...
export default definePluginMetadata('unicorn', {
  ...
  rules: {
    ...
    'no-magic-array-flat-depth': {stylistic: true},
    ...
    'no-subtraction-comparison': {stylistic: true},
    ...
    'no-unnecessary-array-splice-count': {stylistic: true},
    ...
    'no-unsafe-string-replacement': {disableInCodeBlocks: 'tooStrict'},
    'no-unused-array-method-return': {disableInCodeBlocks: 'runtimeOnly'},
    'no-useless-boolean-cast': {stylistic: true},
    ...
    'no-useless-template-literals': {stylistic: true},
    ...
    'prefer-array-flat': {stylistic: true},
    ...
    'prefer-array-index-of': {stylistic: true},
    ...
    'prefer-at': {requiresTypeInfo: ['optional', 'indirect'], stylistic: true},
    ...
    'prefer-minimal-ternary': {stylistic: true},
    ...
    'prefer-number-properties': {stylistic: true},
    ...
    'prefer-single-call': {stylistic: true},
