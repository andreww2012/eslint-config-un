...
export default ((context, optionsRaw) => {
  ...
  configBuilder
    ...
    .addRule('chai-determinate-assertion', testRulesSeverity) /** @since 1.0.4-alpha.0 */ // [S6092] 🟢🧪 📦 `chai`
    // ⚠️ `camelcase`
    ...
    .addRule('disabled-timeout', testRulesSeverity) /** @since 1.0.4-alpha.0 */ // [S6080] 🟢🧪 📦 `chai`
    ...
    .addRule('inverted-assertion-arguments', testRulesSeverity) /** @since 1.0.4-alpha.0 */ // [S3415] 🟢🧪 📦 `mocha`
    ...
    .addRule('no-code-after-done', testRulesSeverity) /** @since 1.0.4-alpha.0 */ // [S6079] 🟢🧪 📦 `mocha`
    ...
    .addRule('no-same-argument-assert', testRulesSeverity) /** @since 1.0.4-alpha.0 */ // [S5863] 🟢🧪 📦 `chai`
