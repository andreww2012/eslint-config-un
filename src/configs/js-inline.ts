...
> {
   ...
   * This behavior doesn't apply to `module` scripts (ie: `<script type="module">` and most
   * transpiled code), where each script tag gets its own top-level scope.
   * `eslint-plugin-html` will use this option (`sourceType`) as well to know if the scopes should
