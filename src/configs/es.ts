  ...
  (
    ...
    if (!isEsVersionFullySupported(2025)) {
      mainConfig
        ...
        .addRule(
          'no-iterator-prototype-drop',
          grs(2025, 'iteratorPrototypeDrop'),
        ) /** @since 8.1.0 */
        .addRule(
        ...
        .addRule(
          ...
          grs(2025, 'iteratorPrototypeFind'),
        ) /** @since 8.1.0 */
        .addRule(
        ...
        .addRule(
          ...
          grs(2025, 'iteratorPrototypeSome'),
        ) /** @since 8.1.0 */
        .addRule(
          'no-iterator-prototype-take',
          grs(2025, 'iteratorPrototypeTake'),
        ) /** @since 8.1.0 */
        .addRule(
    ...
    if (!isEsVersionFullySupported(2015)) {
      mainConfig
        ...
        .addRule(
          ...
          grs(2015, 'arrayPrototypeEntries'),
        ) /** @since 5.0.0 */
        ...
        .addRule(
          ...
          grs(2015, 'binaryNumericLiterals'),
        ) /** @since 1.0.0 */
        ...
        .addRule(
          ...
          grs(2015, 'objectSuperProperties'),
        ) /** @since 1.1.0 */
        ...
        .addRule(
          ...
          grs(2015, 'stringPrototypeRepeat'),
        ) /** @since 5.0.0 */
        .addRule(
    ...
    mainConfig
      ...
      .addRule(
        'no-nonstandard-intl-relativetimeformat-prototype-properties',
        OFF,
      ) /** @since 8.2.0 */
