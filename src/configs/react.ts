...
export interface ReactEslintConfigOptions<ExtraPlugins extends ExtraPluginsType = never>
  ...
  configHooks?:
    | boolean
    | (UnConfigOptions<ExtraPlugins, 'react-hooks' | '@eslint-react/hooks-extra'> & {
        /**
    ...
    | UnConfigOptions<
        ...
        'react-refresh',
        {
          ...
          options?: PrettifyShallow<
            Omit<GetRuleOptions<'react-refresh', 'only-export-components'>, 'allowExportNames'>
          >;
        }
      >;
  ...
  async (
    ...
    configBuilderReactOriginal
      ...
      .addRule(
        ...
        getDoubleRuleSeverity(FILENAME_EXTENSION_SEVERITY, false),
        [
          {
