...
export interface VueEslintConfigOptions<ExtraPlugins extends ExtraPluginsType = never>
  ...
  configI18n?:
    ...
    | PrettifyShallow<
        ...
        } & UnConfigOptions<ExtraPlugins, '@intlify/vue-i18n'>
      >;
...
export default defineUnConfig(
  ...
  async (
    context,
    optionsRaw,
    {vanillaFinalFlatConfigRules}: {vanillaFinalFlatConfigRules: Partial<RulesRecord>},
  ) => {
    ...
    configBuilder
      ...
      .addRule('component-name-in-template-casing', ERROR, [
        'kebab-case',
        {
          ...
          ignores: [
            '/^[A-Z][a-z]+$/' /* Single word components must start with a capital letter */,
          ],
        },
      ]) /** @since 5.0.0 */
      ...
      .addRule('define-props-declaration', ERROR, [
        enforcePropsDeclarationStyle,
      ]) /** @since 9.5.0 */
      ...
      .addRule(
        ...
        ...getRuleUnSeverityAndOptionsFromEntry(
          ...
          [
            optionsResolved.noPropertyAccessFromIndexSignatureSetInTsconfigForVueFiles
              ? OFF
              : ERROR,
