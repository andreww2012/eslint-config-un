...
import {createPluginObjectRenamer, genFlatConfigEntryName, warnUnlessForcedError} from '../utils';
...
export const importEslintConfig = (
  ...
  const noUnresolvedIgnores = toArray(options.importPatternsToIgnoreWhenTryingToResolve);
