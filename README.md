...
| ![Zod](./assets/logos-zod.svg) `importZod`                                          | ❌                                                                     | [eslint-plugin-import-zod](https://npmx.dev/eslint-plugin-import-zod) (`import-zod`)                                                                | Enforces namespace imports for `zod`. You should probably use `zod` config instead.<br>Since v1.0.0 |
