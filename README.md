...
| ![Nuxt](./assets/logos-nuxt.svg) `vue/nuxt`          | ✅ (`nuxt` is installed)                                 | [@nuxt/eslint-plugin](https://npmjs.com/@nuxt/eslint-plugin) (`nuxt`)                                                                                         | Since v1.0.0                                                                                                                       |
| ![Nuxt](./assets/logos-nuxt.svg) `vue/nuxt/config`   | ✅                                                       | [@nuxt/eslint-plugin](https://npmjs.com/@nuxt/eslint-plugin) (`nuxt`)                                                                                         | Rules related to Nuxt config file<br>Since v1.0.0                                                                                  |
...
Provides some useful rule options snippet generators which can be aggravating to write manually:
