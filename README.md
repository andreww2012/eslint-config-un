...
| `ripple`                                             | ✅ (`ripple` is installed)                               | [@tsrx/eslint-plugin](https://npmjs.com/@tsrx/eslint-plugin) (`ripple`)                                                                                       | Since v1.0.0                                                                                                                       |
...
| ![Astro] `astro`                                     | ✅ (`astro` is installed)                                | [eslint-plugin-astro](https://npmjs.com/eslint-plugin-astro) (`astro`)                                                                                        | Since v0.9.0<br>Without A11Y rules                                                                                                 |
...
| ![TanStack] `tanstackQuery`                                                         | ✅ (`@tanstack/query-core` is installed)                               | [@tanstack/eslint-plugin-query](https://npmjs.com/@tanstack/eslint-plugin-query) (`@tanstack/query`)                                                 | Since v1.0.0                                                                                        |
| ![TanStack] `tanstackRouter`                                                        | ✅ (`@tanstack/react-router` or `@tanstack/solid-router` is installed) | [@tanstack/eslint-plugin-router](https://npmjs.com/@tanstack/eslint-plugin-router) (`@tanstack/router`)                                              | Since v1.0.0                                                                                        |
| ![TanStack] `tanstackStart`                                                         | ✅ (`@tanstack/react-start` or `@tanstack/solid-start` is installed)   | [@tanstack/eslint-plugin-start](https://npmjs.com/@tanstack/eslint-plugin-start) (`@tanstack/start`)                                                 | Since v1.0.0                                                                                        |
...
| ![Zod](./assets/logos-zod.svg) `zod`                                                | ✅ (`zod@>=4` is installed)                                            | [eslint-plugin-zod](https://npmjs.com/eslint-plugin-zod) (`zod`)                                                                                     | Since v1.0.0                                                                                        |
